...
_C.DATA.MEAN = [0.,0.,0.]
_C.DATA.STD = [1., 1., 1.]
_C.DATA.DATASET_NAME = "CifarDataset"
_C.DATA.DATALOADER_NAME = "infinite_fullysup"
...
_C.MODEL.LOSS.UNSUPERVISED_WEIGHT = 1.
