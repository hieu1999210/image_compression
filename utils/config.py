...
_C.MODEL.LOSS = CN()
_C.MODEL.LOSS.DISTORTION_LOSS_NAMES = ["MSE"]
_C.MODEL.LOSS.DISTORTION_LOSS_WEIGHT = 1.
_C.MODEL.LOSS.REDUCTION = "none"
_C.MODEL.LOSS.SSIM = CN()
_C.MODEL.LOSS.SSIM.MAX_VAL = 255.
_C.MODEL.LOSS.SSIM.FILTER_SIZE = 11
_C.MODEL.LOSS.SSIM.FILTER_SIGMA = 1.5
_C.MODEL.LOSS.SSIM.K1 = 0.01
_C.MODEL.LOSS.SSIM.K2 = 0.03
